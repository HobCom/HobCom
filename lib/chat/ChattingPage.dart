...
import 'package:hobcom/chat/widgets/FullImageWidget.dart';
                        ...
                        children: <Widget>[
                          CircleAvatar(
                            ...
                            backgroundColor: Colors.black,
                                            backgroundImage: receiverImage!=null?CachedNetworkImageProvider(receiverImage):AssetImage("lib/asset/Person_icon.jpg"),
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Future readFromLocal() async {
    ...
    if (id.hashCode <= receiverId.hashCode) {
      chatID = '$id-$receiverId'; //chat room id
    } else {
          ...
          Column(
            children: <Widget>[
              Container(
                  padding: EdgeInsets.fromLTRB(15, 10, 15, 10),
                  margin: EdgeInsets.only(
                      bottom: isLastMsgRight(index) ? 20 : 10, left: 180),
                  child: Text(
                    DateFormat("dd MMMM, yyyy- hh:mm:aa").format(
                        DateTime.fromMillisecondsSinceEpoch(
...
// row3
  ...
  Future uploadImageToFirebaseStorage() async {
    ...
    uploadTask.whenComplete(() async{
      var image = await storageReference.getDownloadURL();
